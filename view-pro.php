...
$query = "SELECT * FROM pro ORDER BY pro_id";
...
if ($users) {
	while ($user = mysqli_fetch_assoc($users)){
		...
		$user_list .= "<td><a href = \"edit-pro.php?user_id={$user['pro_id']}\">Edit</a></td>";
		$user_list .= "<td><a href = \"delete-pro.php?user_id={$user['pro_id']}\"onclick=\"return confirm('Are you sure you want to permenantly remove this Professioner?');\">Delete</a></td>";
