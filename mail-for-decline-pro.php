...
if (isset($_POST['declinepro'])){
		...
		$mail->Body    = '<b>your request has been Declined.</b>';
		...
		if ($results) {
			header('Location: view-pro.php?msg=failed_to_delete');
			

		}else{
			$_SESSION['message'] = " Selected request removed from the request list ";
			header('Location: view-requests.php?msg=post_deleted');
		}
	}
}
?>
