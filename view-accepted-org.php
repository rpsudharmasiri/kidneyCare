...
if ($users) {
	while ($user = mysqli_fetch_assoc($users)){
		...
		echo "<a style = \"border:solid 0.5px; float:right; padding:5px; \" href = \"remove-org.php?user_id={$user['org_id']}\"onclick=\"return confirm('Are you sure you want to remove selected organ donor?');\">Remove</a></td>";
