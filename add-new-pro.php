	...
	//checking max length
		...
		if (empty($errors)) {
			...
			if ($result) {
				...
				$_SESSION['message'] = " $first_name , You have successfully registered as a Prfessional";
...
<body>
	...
	<header>
		<div class = "appname">CKD Management system</div>
	...
	<p>Tell us about yourself</p>
		...
		<form action="add-new-pro.php" class="add-pro" method="post">
