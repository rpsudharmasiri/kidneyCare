	...
	if (isset($_GET['user_id'])) {
		...
		if ($result_set) {
			if (mysqli_num_rows($result_set) == 1) {
				...
				//user not found
				header('Location: view-questions.php?err=user_not_found');
			}
...
<html>
<head>
	<title>Details of the Uploader</title>
...
<body>
	...
	<h1>Details of the Uploader</h1>
		...
		<p>
			...
			<input type="text" name="pro_for"<?php echo 'value ="' . $pro_for . '"'; ?>disabled>
		</p>
