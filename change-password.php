...
<?php 
	...
	//checking max length
		...
		if (empty($errors)) {
			...
			//query
			$query = "UPDATE general_users SET password ='{$hashed_password}' WHERE guser_id = {$_SESSION['guser_id']} LIMIT 1 ";
			...
			if ($result) {
				...
				header('Location: my.php?password_updated_true');
			} else {
...
<body>
	...
	<h1> Change Password</h1>
		...
		<a href="change-password.php">Cancel</a>
		...
		<form action="change-password.php" class="add-user" method="post">
